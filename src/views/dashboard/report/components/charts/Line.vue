    ...
    default: () => {
      return {
        ...
        content: [
          {
            dimensionTitle: "",
            dimensionName: ["积极认知", "情绪控制", "家庭支持", "人际协助", "目标专注"],
            dimensionScore: [
              32.80487804878048, 59.959349593495936, 39.03614457831325, 48.405797101449274, 40.5,
            ],
          },
          [
            {
              data: ["积极认知", "32.80487804878048"],
            },
            {
              data: ["情绪控制", "59.959349593495936"],
            },
            {
              data: ["家庭支持", "39.03614457831325"],
            },
            {
              data: ["人际协助", "48.405797101449274"],
            },
            {
              data: ["目标专注", "40.5"],
            },
