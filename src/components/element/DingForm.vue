  ...
  <div class="page-container">
    ...
    >
      ...
      >
        ...
        >
          {{
            itemForm.checkboxOption.label ? itemForm.checkboxOption.label : itemForm.checkboxOption
          }}
        </el-checkbox>
        ...
        <el-input
          ...
          :show-password="itemForm.isPassword"
        />
        <el-input-number v-if="itemForm.type === 'input-number'" v-model="formParams.data[key]" />
        <el-select
        ...
        <el-rate v-if="itemForm.type === 'rate'" v-model="formParams.data[key]" />
        <el-color-picker v-if="itemForm.type === 'color-picker'" v-model="formParams.data[key]" />
        <el-transfer
        ...
        />
        <!-- id="richText" -->
        <div v-if="itemForm.type === 'richText'" :id="key.toString()" ref="richText" />
        <slot
